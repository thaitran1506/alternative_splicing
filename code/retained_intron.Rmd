...
```{r}
se_sol = read.csv("~/Desktop/alternative_splicing/alternative_splicing/data/rmats_soleus_WT_MT/RI.MATS.JC.txt",
                  sep = "\t",
...
```{r}
write.csv(se_sol_final, "~/Desktop/alternative_splicing/alternative_splicing/output/RI_sol_WT_vs_MT_final.csv")
```
...
```{r}
se_sol = read.csv("~/Desktop/alternative_splicing/alternative_splicing/data/rmats_tibialis_WT_MT/RI.MATS.JC.txt",
                  sep = "\t",
                  stringsAsFactors = FALSE)
```
...
```{r}
write.csv(se_tib_final, "~/Desktop/alternative_splicing/alternative_splicing/output/RI_tib_WT_vs_MT_final.csv")
```
...
```{r}
  se_sol = read.csv("~/Desktop/alternative_splicing/alternative_splicing/data/rmats_soleus_tib_WT/RI.MATS.JC.txt",
                  sep = "\t",
                  stringsAsFactors = FALSE)
```
...
```{r}
write.csv(se_WT_final, "~/Desktop/alternative_splicing/alternative_splicing/output/RI_WT_sol_vs_tib_final.csv")
```

MT Soleus vs Tibialis

```{r}
se_sol = read.csv("~/Desktop/alternative_splicing/alternative_splicing/data/rmats_soleus_tib_MT/RI.MATS.JC.txt",
                  sep = "\t",
                  stringsAsFactors = FALSE)
```
...
```{r}
write.csv(se_MT_final, "~/Desktop/alternative_splicing/alternative_splicing/output/RI_MT_sol_vs_tib_final.csv")
```
